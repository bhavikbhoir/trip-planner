...
- **Navigation**: `TripTabs.jsx` — Itinerary / Today / Bookings / Expenses tab strip on every trip page (scrolls horizontally on narrow screens); `AppShell.jsx` — global shell with a polling notification bell (member joined, suggestion added, plan regenerated) and a Settings link.
